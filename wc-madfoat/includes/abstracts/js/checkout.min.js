					...
					success:	function( result ) {
						try {
							if( 'success' === result.result && result.iframe_url != undefined){
								$(".payment_box.payment_method_wcmadfoat").html('<iframe style="width: 100%;height: 500px;border: 0;" id= "madfoat" src= "' + result.iframe_url + '"  sandbox="allow-forms allow-modals allow-popups-to-escape-sandbox allow-popups allow-scripts allow-top-navigation allow-same-origin"></iframe>');
