<?php
/*
 * Madfoat Payment Gateway setting calss
*/
 ...
 */
class WC_Gateway_Madfoat_Settings
{
     ...
     *
     * @return WC_Gateway_Madfoat_Settings Instance of WC_Gateway_Madfoat_Settings
     */
    public function load()
    {
        ...
        $this->_settings          = (array) get_option('woocommerce_wcmadfoat_settings', array());
    ...
    {
        update_option('woocommerce_wcmadfoat_settings', $this->_settings);
    }
